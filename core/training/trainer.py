...
from core.training import handlers
from core.training.swa import SWA
from core.training.train_utils import pretty_string_time
from core.training.train_utils import Timer, HistoryTracker

from torch.utils import collect_env
from core.training import metrics
from core.inference import Predictor
from core import __file__ as arch_src
...
class Trainer:
    ...
    Args:
        ...
        train_dataset: PyTorch dataset (``data.Dataset``) which produces
            ...
            :py:class:`core.data.cnndata.PatchCreator` is currently
    ...
    def _handle_lr(self) -> None:
        ...
        .. note::
            ...
            :py:meth:`core.trainer.SWA.bn_update()` on the model with a
...
class Backup:
    ...
    Args:
        script_path: The path to the training script. Eg. train_neurodata.py
