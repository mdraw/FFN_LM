...
from core.data.transforms import random_blurring
from core.data.transforms.random import Normal, HalfNormal, RandInt
...
class AlbuSeg2d:
    ...
    Wraps an augmentation so it can be used within core's transform pipeline.
